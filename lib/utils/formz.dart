...
/// {@endtemplate}
@immutable
abstract class FormzInput<T extends Object, E extends ValidationError> extends ToJson {
...
mixin FormzInputErrorCacheMixin<T extends Object, E extends ValidationError> on FormzInput<T, E> {
